Return-Path: <linux-embedded+bounces-241-lists+linux-embedded=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-embedded@lfdr.de
Delivered-To: lists+linux-embedded@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id E67D1CFAF93
	for <lists+linux-embedded@lfdr.de>; Tue, 06 Jan 2026 21:43:41 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id EDC1E304F656
	for <lists+linux-embedded@lfdr.de>; Tue,  6 Jan 2026 20:41:35 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 5C7B42DA77E;
	Tue,  6 Jan 2026 20:33:34 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (1024-bit key) header.d=antispam.mailspamprotection.com header.i=@antispam.mailspamprotection.com header.b="y9RsRyT1";
	dkim=fail reason="signature verification failed" (1024-bit key) header.d=valla.it header.i=@valla.it header.b="khWjsIVo"
...
Received: from delivery.antispam.mailspamprotection.com (delivery.antispam.mailspamprotection.com [185.56.87.13])
	...
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 6C9102D7398;
	Tue,  6 Jan 2026 20:33:30 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=pass smtp.client-ip=185.56.87.13
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1767731613; cv=pass; b=or2gCRn42+ZrgDdUnq1nHgqMYROpcFOSdnw39ASBPvWZlfndlUVqDx0JG6FcZKJSNkYo0bt422ddRTu8pqJqCP9m6ghbovy9ZblTk9nDEFpT6K4LcOvuqwfQwcQFm9K7u9DdtiYTzWthJjAm1vHRcj9a8VYK/S6rk9AJqGIQctU=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1767731613; c=relaxed/simple;
	bh=r/WVfM8D0u6PphF/QcCwWbXlfnDlRW60gPxMiR0kmOg=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=TsIyFE3pCSRRLXlClGsx1tEGyQH0yyUVrCey2nP3niiuxci1xoei76wBkhqZIG2IP5N+q7l+zEM91FfEoaX573ubWgbAYZ/KkxaNhubeeys7ps/U4Ca4cBba5z1x4KVNtrgiI7XHut4983JDpHKAHZ1CSxmy0fFE/VYOec6rcys=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=valla.it; spf=pass smtp.mailfrom=valla.it; dkim=pass (1024-bit key) header.d=antispam.mailspamprotection.com header.i=@antispam.mailspamprotection.com header.b=y9RsRyT1; dkim=pass (1024-bit key) header.d=valla.it header.i=@valla.it header.b=khWjsIVo; arc=pass smtp.client-ip=185.56.87.13
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=valla.it
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=valla.it
ARC-Seal: i=1; cv=none; a=rsa-sha256; d=outgoing.instance-europe-west4-fg2f.prod.antispam.mailspamprotection.com; s=arckey; t=1767731610;
	 b=;
ARC-Authentication-Results: i=1; outgoing.instance-europe-west4-fg2f.prod.antispam.mailspamprotection.com; smtp.remote-ip=35.214.173.214;
	...
	arc=none
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed; d=outgoing.instance-europe-west4-fg2f.prod.antispam.mailspamprotection.com; s=arckey; t=1767731610;
	bh=r/WVfM8D0u6PphF/QcCwWbXlfnDlRW60gPxMiR0kmOg=;
	h=In-Reply-To:Content-Type:MIME-Version:References:Message-ID:Subject:Cc:To:
	  From:Date:DKIM-Signature:DKIM-Signature;
	b=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	d=antispam.mailspamprotection.com; s=default; h=CFBL-Feedback-ID:CFBL-Address
	:Content-Type:MIME-Version:Message-ID:Subject:Cc:To:From:Date:Reply-To:
	List-Unsubscribe:Content-Transfer-Encoding;
	bh=Su9p4oA45ovgHzMkhuUMkIHTBIDNajE6KYNmkt0GXOU=; b=y9RsRyT1AulH3sONVD+vtUeUGq
	bCbVSkhZcQVDy8BN56B/TxtorgHslu/cIDqOHSabfySKKRWfQ2rUakwpWHZ+LAf9z9iGVc1g78IBa
	t4R2Edc6yGFH8MtFUEp20svfZrTGnsiBQhja31uQ40TKYzDThPs3PitZHRpwgagEG7eU=;
Received: from 214.173.214.35.bc.googleusercontent.com ([35.214.173.214] helo=esm19.siteground.biz)
	...
	id 1vdDk5-0000000F7hM-2x44;
	Tue, 06 Jan 2026 20:33:28 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=valla.it;
	s=default; h=Subject:Cc:To:From:Date:list-help:list-unsubscribe:
	list-subscribe:list-post:list-owner:list-archive;
	bh=Su9p4oA45ovgHzMkhuUMkIHTBIDNajE6KYNmkt0GXOU=; b=khWjsIVoyAr3oavTy7ZWTyFb32
	J+zrT0SwUAxK+X6W4qKKv7lNQSrb7Awk9G/+I0oO43dl4bEuo2CjGkgklvIsVkx91edHqDa0PoHxV
	5EfyUrwWIst9HLXWIpDeJhugjqtOpgTThdbZZ8SFD8BDmeYsynzoPjhqZlACT2Hy69h0=;
Received: from [95.248.141.113] (port=59429 helo=bywater)
	by esm19.siteground.biz with esmtpsa  (TLS1.3) tls TLS_AES_256_GCM_SHA384
	(Exim 4.98.1)
	(envelope-from <francesco@valla.it>)
	id 1vdDjh-00000000A2t-1q0J;
	Tue, 06 Jan 2026 20:33:01 +0000
...
X-Source-Args: 
X-Source-Dir: 
X-SGantispam-id: 69080fad73780c8905d648b24e4e5bbc
AntiSpam-DLS: false
AntiSpam-DLSP: 
AntiSpam-DLSRS: 
AntiSpam-TS: 1.0
CFBL-Address: feedback@antispam.mailspamprotection.com; report=arf
CFBL-Feedback-ID: 1vdDk5-0000000F7hM-2x44-feedback@antispam.mailspamprotection.com
